...
<div style="max-width:640px;">
    <div style="background:#fff;border:1px solid #E2E8F0;border-radius:8px;padding:28px;">
        ...
        <form method="POST" action="{{ route('owner.fields.update', $lapangan) }}" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama', $lapangan->nama) }}" required
            ...
            <div>
                ...
                <select name="cabor_id" required
                    ...
                    <option value="{{ $cabor->id }}" {{ old('cabor_id', $lapangan->cabor_id) == $cabor->id ? 'selected' : '' }}>{{ $cabor->nama_cabor }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3"
                          style="width:100%;padding:10px 14px;border:1px solid #E2E8F0;border-radius:6px;font-size:0.875rem;outline:none;resize:vertical;">{{ old('deskripsi', $lapangan->deskripsi) }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="fasilitas" rows="2"
                          style="width:100%;padding:10px 14px;border:1px solid #E2E8F0;border-radius:6px;font-size:0.875rem;outline:none;resize:vertical;">{{ old('fasilitas', $lapangan->fasilitas) }}</textarea>
            </div>
            ...
            <div>
                ...
                <div style="margin-bottom:8px;">
                    <img src="{{ asset('storage/' . $lapangan->foto) }}" alt="Foto" style="max-height:120px;border-radius:6px;">
                </div>
                @endif
                <input type="file" name="foto" accept="image/*" style="font-size:0.875rem;color:#64748B;">
                <p style="font-size:0.75rem;color:#94A3B8;margin-top:4px;">Kosongkan jika tidak ingin mengubah foto.</p>
            </div>
