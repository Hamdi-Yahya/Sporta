...
<div style="background:#fff;border:1px solid #E2E8F0;border-radius:8px;overflow:hidden;">
    ...
    <div style="display:flex;align-items:flex-start;gap:12px;padding:14px 20px;border-bottom:1px solid #F1F5F9;
        ...
        <div style="flex:1;">
            <div style="display:flex;align-items:center;justify-content:space-between;">
                ...
                <span style="font-size:0.6875rem;color:#94A3B8;">{{ $notif->created_at->diffForHumans() }}</span>
            </div>
            <p style="font-size:0.8125rem;color:#64748B;margin:4px 0 0;line-height:1.5;">{{ $notif->isi }}</p>
        </div>
